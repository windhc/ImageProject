...
angular.module('admin.Atlas', ['ngTable', 'ngResource', 'blueimp.fileupload'])
    ...
    .controller('AtlasCtrl', ['$scope', '$timeout', '$resource', '$filter', 'ngTableParams','AtlasService',
        function ($scope, $timeout, $resource, $filter, ngTableParams,AtlasService) {
    ...
    .controller('AtlasAddCtrl', ['$scope', '$routeParams','$http', '$filter', '$window',
        'PicTypeService','TagService', 'AtlasService',
        function ($scope, $routeParams, $http, $filter, $window, PicTypeService, TagService, AtlasService) {
            $scope.atlas = {};
            $scope.atlas.tagIds = [];
            $scope.atlas.files = [];
